...
Kanca yalnız YAZMA araçlarını (Edit/MultiEdit/Write/NotebookEdit) değerlendirir —
okuma ve komut araçlarına hiç karışmaz. Yazma çağrısında `korunan-yollar.txt`e bakar:
...
yeni yazma araçları kapsam DIŞIDIR — onları ikinci hat (bekçi) yakalar.
Okuma her zaman serbesttir (koruma yazmaya karşıdır).
