...
- **Desen sınıfları (jenerik üçlü + işaret listesi):**
  ...
  3. `kart` — 15-16 hane (boşluk/tire gruplu normalize), ilk hane **2-6** (U64, 2026-08-08: 3-6 idi ve Mastercard 2-serisi — 2017'den beri canlı BIN aralığı — temiz geçiyordu), **Luhn doğrulamalı**. 15-16 dışı uzunluklar kapsam dışı (beyanlı — Maestro 12-19 ucu yanlış-pozitife değmez).
