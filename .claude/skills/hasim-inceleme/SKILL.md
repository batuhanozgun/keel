---
description: Hasım inceleme düğmesi — verilen commit paketini çok-mercekli bul→çürüt hattından geçirir (salt-okunur). Uzun ve yakıt-yoğun koşu; büyük yama paketinde kapanış mühründen önce kullanılır.
...
1. **Maliyet uyarısını bas:** "Bu koşu uzun sürer ve yakıt yakar (ölçü: paket boyuna göre ~10-20 alt-ajan). Küçük işte gerekmez; büyük yama paketinde kapanış mühründen önce anlamlıdır." İsteyen yine de istiyorsa devam.
